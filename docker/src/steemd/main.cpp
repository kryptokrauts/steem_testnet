...
int main(int argc, char** argv) {
   ...
   try {
      ...
      std::cerr << "omnikraut public key: " << STEEMIT_INIT_PUBLIC_KEY_STR << "\n";
      std::cerr << "omnikraut private key: " << initminer_private_key << "\n";
      std::cerr << "chain id: " << std::string(STEEMIT_CHAIN_ID) << "\n";
      std::cerr << "blockchain version: " << fc::string( STEEMIT_BLOCKCHAIN_VERSION ) << "\n";
      std::cerr << "kryptokrauts enhancements version: 0.0.1 \n";
      std::cerr << "------------------------------------------------------\n";
#else
      std::cerr << "------------------------------------------------------\n\n";
